...
export function useAddProjectModal({ domain }: { domain?: string }) {
  ...
  const AddProjectModal = useCallback(() => {
    return <AddProjectModalHelper showAddProjectModal={showAddProjectModal} setShowAddProjectModal={setShowAddProjectModal} />;
  }, [showAddProjectModal, setShowAddProjectModal, domain]);

  return useMemo(() => ({ setShowAddProjectModal, AddProjectModal }), [setShowAddProjectModal, AddProjectModal]);
}
