    ...
    <Modal showModal={showInviteTeammateModal} setShowModal={setShowInviteTeammateModal}>
      <div className="inline-block w-full transform overflow-hidden bg-white align-middle shadow-xl transition-all sm:max-w-md sm:rounded-2xl sm:border sm:border-gray-200">
        <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
          ...
          <p className="text-center text-sm text-gray-500">Invite a teammate to join your project.</p>
        </div>
        ...
        >
          ...
          >
            {state === 'inviting' ? <LoadingDots color="#808080" /> : <p>Send invite</p>}
          </button>
...
export function useInviteTeammateModal() {
  ...
  const InviteTeammateModalCallback = useCallback(() => {
    return <InviteTeammateModal showInviteTeammateModal={showInviteTeammateModal} setShowInviteTeammateModal={setShowInviteTeammateModal} />;
